...
Converted["_KR"].Font = Enum.Font.SourceSans
Converted["_KR"].Text = "KRNL hint"
Converted["_KR"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_KR"].TextScaled = true
Converted["_KR"].TextSize = 14
Converted["_KR"].TextWrapped = true
Converted["_KR"].AutoButtonColor = false
Converted["_KR"].BackgroundColor3 = Color3.fromRGB(16.000000946223736, 16.000000946223736, 16.000000946223736)
Converted["_KR"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_KR"].BorderSizePixel = 0
Converted["_KR"].Position = UDim2.new(0.1251605, 0, 0.308291346, 0)
Converted["_KR"].Size = UDim2.new(0, 113, 0, 42)
Converted["_KR"].Name = "KR"
Converted["_KR"].Parent = Converted["_Presets"]
